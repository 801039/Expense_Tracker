...
export const expenses =  <i className="fa-solid fa-money-bill-wave"></i>
export const money = <i className="fa-solid fa-money-bill-wave"></i>
export const freelance =  <i className="fa-solid fa-handshake"></i>
export const stocks = <i className="fa-solid fa-chart-line"></i>
...
export const medical = <i className="fa-solid fa-syringe"></i>
